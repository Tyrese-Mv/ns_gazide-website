...
import { SOCIAL_LINKS, COMPANY_INFO, CONTACT_INFO } from '../utils/constants';
import './Footer.css';
      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section footer-about">
            <p className="footer-logo"><strong>{COMPANY_INFO.name.toUpperCase()}</strong></p>
          ...
          <div className="footer-section footer-contact">
            ...
            <div className="footer-contact-info">
              ...
              <p>
                ...
                <a href={CONTACT_INFO.emailLink}>{CONTACT_INFO.email}</a>
              </p>
              <p>
